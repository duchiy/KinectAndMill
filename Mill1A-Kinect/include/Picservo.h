...
NMCLIB_API SERVOMOD * ServoNewMod();
BOOL NMCLIB_API STD_CALL ServoGetStat(byte addr);
long NMCLIB_API STD_CALL ServoGetPos(byte addr);
byte NMCLIB_API STD_CALL ServoGetAD(byte addr);
short int NMCLIB_API STD_CALL ServoGetVel(byte addr);
byte NMCLIB_API STD_CALL ServoGetAux(byte addr);
long NMCLIB_API STD_CALL ServoGetHome(byte addr);
short int NMCLIB_API STD_CALL ServoGetPError(byte addr);
byte NMCLIB_API STD_CALL ServoGetNPoints(byte addr);
long NMCLIB_API STD_CALL ServoGetCmdPos(byte addr);
long NMCLIB_API STD_CALL ServoGetCmdVel(byte addr);
long NMCLIB_API STD_CALL ServoGetCmdAcc(byte addr);
long NMCLIB_API STD_CALL ServoGetStopPos(byte addr);
byte NMCLIB_API STD_CALL ServoGetCmdPwm(byte addr);
byte NMCLIB_API STD_CALL ServoGetMoveCtrl(byte addr);
byte NMCLIB_API STD_CALL ServoGetStopCtrl(byte addr);
byte NMCLIB_API STD_CALL ServoGetHomeCtrl(byte addr);
byte NMCLIB_API STD_CALL ServoGetIoCtrl(byte addr);
void NMCLIB_API STD_CALL ServoGetGain(byte addr, short int * kp, short int * kd, short int * ki,
				  short int * il, byte * ol, byte * cl, short int * el,
                  byte * sr, byte * dc);
void NMCLIB_API STD_CALL ServoGetGain2(byte addr, short int * kp, short int * kd, short int * ki,
				  short int * il, byte * ol, byte * cl, short int * el,
                  byte * sr, byte * dc, byte * sm);
BOOL NMCLIB_API STD_CALL ServoSetGain(byte addr, short int kp, short int kd, short int ki,
				  short int il, byte ol, byte cl, short int el,
                  byte sr, byte dc);
BOOL NMCLIB_API STD_CALL ServoSetGain2(byte addr, short int kp, short int kd, short int ki,
				  short int il, byte ol, byte cl, short int el,
                  byte sr, byte dc, byte sm);
BOOL NMCLIB_API STD_CALL ServoResetPos(byte addr);
BOOL NMCLIB_API STD_CALL ServoResetRelHome(byte addr);
BOOL NMCLIB_API STD_CALL ServoSetPos(byte addr, long pos);
BOOL NMCLIB_API STD_CALL ServoClearBits(byte addr);
BOOL NMCLIB_API STD_CALL ServoStopMotor(byte addr, byte mode);
BOOL NMCLIB_API STD_CALL ServoStopHere(byte addr, byte mode, long pos);
BOOL NMCLIB_API STD_CALL ServoSetIoCtrl(byte addr, byte mode);
BOOL NMCLIB_API STD_CALL ServoLoadTraj(byte addr, byte mode, long pos, long vel, long acc, byte pwm);
void NMCLIB_API STD_CALL ServoInitPath(byte addr);
BOOL NMCLIB_API STD_CALL ServoAddPathpoints(byte addr, int npoints, long *path, int freq);
BOOL NMCLIB_API STD_CALL ServoStartPathMode(byte groupaddr, byte groupleader);
BOOL NMCLIB_API STD_CALL ServoStartMove(byte groupaddr, byte groupleader);
BOOL NMCLIB_API STD_CALL ServoSetHoming(byte addr, byte mode);
BOOL NMCLIB_API STD_CALL ServoHardReset(byte addr, byte mode);
};
#endif
